...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    return something.push(`name: ${name.animal_name}, scientific: ${name.scientific_name}`);
  })
  return something;
  }
  ...
  */
  ...
  function lowerCaseNames(info){
    const lowNames = info.map(function(lower){
  ...
  */
  ...
  function lowPopulationAnimals(info){
    let population = info.filter(function(pop){
  ...
  */
  ...
  function USApop(callback){
    let totalPop = callback.reduce(function(counter,item){
      return counter + (item.population);
    }, 0);
    return totalPop;
  }
